...
public class VendorUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner=(Spinner)findViewById(R.id.document_venorderspinner);
        ...
        attach=(ImageView)findViewById(R.id.venfile_attach);
        scanner=(ImageView)findViewById(R.id.vencam_scanner);
